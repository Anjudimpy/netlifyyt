...
import AboutTestimonialCrd from './AboutTestimonialCard';
...
const AboutTestimonial = () => {
  ...
  return (
    ...
    >
        <div className="absolute top-0 left-0 w-full  bg-black opacity-40"></div>
    

{/* contain */}
<div className='w-full'>
<div className='xl:h-[700px]  lg:h-[270px] sm:h-[180px] xs:h[180px] w-full xl:py-16 lg:py-16 sm:py-10 xs:py-10 justify-center text-center bg-[#fad8d8]'>
            ...
            <h5 className='xl:text-[40px] lg:text-[40px] sm:text-[25px] font-bold text-white absolute xl:w-[19.1rem] lg:w-[19rem] sm:w-[12rem] xs:w-[10.5rem] xs:text-[22px] textShadow2 flex text-center top-12'>Our Testimonial</h5>
            </span>


            <div className='justify-center mx-20  mt-16'>
                <div>
                <AboutTestimonialCrd/>
                </div>
            </div>
...
<Image src={con} alt='' className='xl:h-[210px] lg:h-[210px] sm:h-[150px] xs:h-[150px] my-20 md:w-[1250px] sm:w-[24.5rem] xs:w-[18.5rem] rounded-full'/>
                <div className="absolute top-0 my-20 md:w-[1250px] sm:w-[24.5rem] xs:w-[18.5rem] xl:h-[210px] lg:h-[210px] sm:h-[150px] xs:h-[150px] bg-black opacity-80 rounded-full"></div>
               
               
                         
                <div className='absolute my-[4.5rem] lg:py-[4.5rem] sm:my-[4.5rem] xs:py-[1.8rem]  lg:px-10 xl:px-12 sm:px-7 text-white top-0 xl:flex items-center justify-between w-full lg:gap-14 xl:gap-14'>
