  ...
  return (
    <div className=' w-full'>
       <div className='xl:h-[270px] lg:h-[270px] sm:h-[180px] xs:h[180px] w-full xl:py-16 lg:py-16 sm:py-10 xs:py-10 justify-center text-center bg-[#fad8d8]'>
            ...
            <h5 className='xl:text-[40px] lg:text-[40px] sm:text-[25px] font-bold text-white absolute xl:w-[19.1rem] lg:w-[19rem] sm:w-[12rem] xs:w-[11.5rem] textShadow2 flex text-center top-12'>Contact With Us</h5>
            </span>
            </div>


            <div className='relative xl:mx-28 lg:mx-28 sm:mx-5  xs:mx-5'>
                <Image src={con} alt='' className='xl:h-[210px] lg:h-[210px] sm:h-[150px] xs:h-[150px] my-20 w-[1250px]  rounded-full'/>
                <div className="absolute top-0  xl:w-[78.1rem] lg:w-[79rem] sm:w-[24.5rem] xs:w-[24.5rem] xl:h-[210px] lg:h-[210px] sm:h-[150px] xs:h-[150px] bg-black opacity-80 rounded-full"></div>
               
                <div className='absolute xl:py-[4.5rem] lg:py-[4.5rem] sm:py-[1.5rem] lg:px-10 xl:px-12 sm:px-7 text-white top-0 xl:flex items-center justify-between w-full lg:gap-14 xl:gap-14'>
                ...
                <div className='flex sm:mt-2 sm:-ml-3'>
  <span className="vedio-button sm:text-[15px]">
            <MdCall  className=' absolute  bg-[#e03202]  h-10 p-1 w-10 rounded-full' />
          </span>
          <div className=' font-bold xl:text-[27px] lg:text-[27px] text-amp_red sm:text-[16px] sm:mt-1 '>+918110977771</div>
<div className='xl:ml-10 xl:mr-5 lg:ml-10 lg:mr-5'>
