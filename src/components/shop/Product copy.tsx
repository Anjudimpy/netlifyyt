                    ...
                    rounded-lg group overflow-hidden">
                        ...
                        transition-transform duration-300">
                            <span onClick={()=>dispatch( 
                               addToCart({
                                ...
                                image:image,
                                quantity:1,
                            }) )} className="w-full h-full text-amp_blue border-b-[1px] border-b-gray-400 flex items-center justify-center 
                            text-xl bg-transparent hover:bg-amp_red hover:text-white cursor-pointer duration-300
                            "><HiShoppingCart/></span>
                            <span  onClick={()=>dispatch( 
                               addToFavorite({
                                id:id,
                             ...
                             className="w-full text-amp_blue h-full border-b-[1px] border-b-gray-400 flex items-center justify-center 
                            text-xl bg-transparent hover:bg-amp_red hover:text-white cursor-pointer duration-300
                            "><FaHeart/></span>
                        </div>
                        </div>
                        ...
                        <div className="px-4 py-3 flex flex-col gap-1">
                            ...
                            <p className="flex items-center">
                                <span className="text-amp_blue font-bold">
                            ...
                            className="h-10 font-medium bg-amp_blue text-white round-md hover:bg-amp_red 
