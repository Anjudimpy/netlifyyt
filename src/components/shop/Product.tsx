...
const Products = ({ productData }: { productData: number }) => {
      ...
      <div className=" w-full grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2  xl:grid-cols-4 gap-5">
        {images.map((pic, idx) => (
          ...
          >
           ...
           <div className="bg-amp_blue h-10 w-48 mt-[30px] cursor-pointer hover:bg-amp_red text-white flex justify-center py-2 font-semibold"> Add To Cart</div>
           </div>
           </div>
