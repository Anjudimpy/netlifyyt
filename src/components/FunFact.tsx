...
const FunFact = () => {
  return (
    ...
    <div className='justify-center text-center'>
        ...
        <div className=' absolute flex w-full xl:mt-[15rem]  lg:mt-[15rem] xs:mt-[5rem]  sm:mt-[6rem] xl:px-[6.8rem] lg:px-[6.8rem] sm:px-[1rem] text-center justify-center  xl:gap-40  lg:gap-40 text-white'>

            <div data-aos="fade-up"  data-aos-duration="1000"
              className='group font-bold'><FaHeartbeat className='text-amp_red xl:text-[5rem] lg:text-[5rem] sm:text-[3rem] xs:text-[2rem]  xl:ml-16 lg:ml-16 sm:ml-7 xs:ml-7 group-hover:scale-x-90 group-hover:animate-bounce transition duration-300'/>
            ...
            className='group font-bold'><AiFillProduct className='text-amp_red xs:text-[2rem] xl:text-[5rem] lg:text-[5rem] sm:text-[3rem] xl:ml-12 lg:ml-12 sm:ml-5 xs:ml-5 group-hover:scale-x-90 group-hover:animate-bounce transition duration-300'/>
            ...
            <span className='text-white xl:text-[1.5rem]'>Product Section</span>
             ...
             <div data-aos="flip-left" data-aos-duration="2000"   data-aos-easing="ease-out-cubic"
              className='group font-bold'><RiServiceFill className='text-amp_red xs:text-[2rem] xl:text-[5rem] lg:text-[5rem] sm:text-[3rem] xl:ml-12 lg:ml-12 xs:ml-5 sm:ml-5 group-hover:scale-x-90 group-hover:animate-bounce transition duration-300 '/>
            ...
            className='group font-bold'><GiTrophyCup className='text-amp_red xs:text-[2rem] xl:text-[5rem] lg:text-[5rem] sm:text-[3rem] xl:ml-12 lg:ml-12 sm:ml-5 xs:ml-5 group-hover:scale-x-90 group-hover:animate-bounce transition duration-300'/>
